  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered ? `0 16px 48px ${concept.color}15` : 'none',
        cursor: 'default',
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .concept-card { animation: fadeUp 0.6s ease both; }

        /* ── CTA buttons ── */
        .cta-btn {
          position: relative; overflow: hidden; background: transparent;
          border: 1.5px solid #6EE7D0; color: #6EE7D0;
          font-family: 'Space Mono', monospace; font-size: 13px; letter-spacing: 0.1em;
          padding: 14px 32px; border-radius: 4px; cursor: pointer;
          transition: color 0.3s; text-transform: uppercase; text-decoration: none !important;
        }
        .cta-btn::before {
          content: ''; position: absolute; inset: 0; background: #6EE7D0;
          transform: scaleX(0); transform-origin: left; transition: transform 0.3s ease; z-index: 0;
        }
        .cta-btn:hover::before { transform: scaleX(1); }
        .cta-btn:hover { color: #080C14 !important; }
        .cta-btn span { position: relative; z-index: 1; }

        .cta-btn-secondary {
          background: transparent; border: 1.5px solid rgba(255,255,255,0.2);
          color: rgba(241,237,228,0.6); font-family: 'Space Mono', monospace;
          font-size: 13px; letter-spacing: 0.1em; padding: 14px 32px; border-radius: 4px;
          cursor: pointer; transition: all 0.3s; text-transform: uppercase; text-decoration: none !important;
        }
        .cta-btn-secondary:hover { border-color: rgba(255,255,255,0.5); color: #F1EDE4 !important; }
        ...
        .comp-row { display: grid; grid-template-columns: 1fr 1fr; gap: 2px; }
        .comp-classical {
          background: rgba(255,255,255,0.025); padding: 14px 24px; font-size: 14px;
          color: rgba(241,237,228,0.65); font-family: 'Lora', serif; line-height: 1.5;
          border-right: 1px solid rgba(255,255,255,0.04);
        }
        .comp-quantum {
          background: rgba(110,231,208,0.04); padding: 14px 24px; font-size: 14px;
          color: rgba(110,231,208,0.85); font-family: 'Lora', serif; line-height: 1.5;
        }
        .comp-row-odd .comp-classical { background: rgba(255,255,255,0.015); }
        .comp-row-odd .comp-quantum   { background: rgba(110,231,208,0.025); }
        .comp-row-header .comp-classical {
          background: rgba(255,255,255,0.05); padding: 16px 24px;
          font-family: 'Space Mono', monospace; font-size: 12px;
          color: rgba(241,237,228,0.5); letter-spacing: 0.1em; text-transform: uppercase;
          border-radius: 12px 0 0 0;
        }
        .comp-row-header .comp-quantum {
          background: rgba(110,231,208,0.08); padding: 16px 24px;
          font-family: 'Space Mono', monospace; font-size: 12px;
          color: #6EE7D0; letter-spacing: 0.1em; text-transform: uppercase;
          border-radius: 0 12px 0 0;
        }
        .comp-row-footer .comp-classical { background: rgba(255,255,255,0.03); padding: 12px 24px; border-radius: 0 0 0 12px; min-height: 20px; }
        .comp-row-footer .comp-quantum   { background: rgba(110,231,208,0.05); padding: 12px 24px; border-radius: 0 0 12px 0; min-height: 20px; }

        /* ── Responsive ── */
        @media (max-width: 768px) {
          .concepts-grid { grid-template-columns: 1fr !important; }
          .hero-title { font-size: clamp(36px, 10vw, 64px) !important; }
          .hero-bloch-sphere { display: none !important; }
          .hero-cta-group { flex-direction: column !important; align-items: stretch !important; max-width: 100% !important; }
          .cta-btn, .cta-btn-secondary { width: 100% !important; box-sizing: border-box !important; text-align: center !important; }
        }

        @media (max-width: 600px) {
          .comparison-table { gap: 8px !important; }
          .comp-row { grid-template-columns: 1fr; border-radius: 10px; overflow: hidden; gap: 1px; background: rgba(255,255,255,0.05); }
          .comp-row-header, .comp-row-footer { display: none; }
          .comp-classical { border-right: none; padding: 10px 14px; }
          .comp-quantum   { padding: 10px 14px; }
          .comp-classical::before {
            content: 'Classical'; display: block; font-family: 'Space Mono', monospace;
            font-size: 9px; letter-spacing: 0.15em; text-transform: uppercase;
            color: rgba(255,255,255,0.35); margin-bottom: 4px;
          }
          .comp-quantum::before {
            content: 'Quantum'; display: block; font-family: 'Space Mono', monospace;
            font-size: 9px; letter-spacing: 0.15em; text-transform: uppercase;
            color: rgba(110,231,208,0.6); margin-bottom: 4px;
          }
          .cta-btn, .cta-btn-secondary { padding: 12px 20px !important; font-size: 12px !important; }
        }
      `}</style>
      ...
      <div style={{ fontFamily: "'Lora', Georgia, serif", background: '#080C14', minHeight: '100vh' }}>
        ...
        <section style={{
          ...
          alignItems: 'center',
          textAlign: 'center',
          padding: 'clamp(80px, 10vh, 120px) clamp(16px, 4vw, 24px) 60px',
          overflow: 'hidden',
        }}>
          <QuantumCanvas />
          ...
          {/* CTA buttons */}
          <div className="hero-cta-group" style={{ display: 'flex', gap: 16, flexWrap: 'wrap', justifyContent: 'center', zIndex: 2, width: '100%', maxWidth: 480 }}>
        ...
        <section
          ...
          data-section="intro"
          style={{ padding: 'clamp(60px, 8vw, 100px) clamp(16px, 4vw, 24px)', maxWidth: 760, margin: '0 auto', ...reveal('intro') }}
        >
          <div style={{
            fontFamily: "'Space Mono', monospace",
            fontSize: 10,
        ...
        <section
          ...
          style={{ padding: 'clamp(32px, 4vw, 40px) clamp(16px, 4vw, 24px) clamp(60px, 8vw, 100px)', maxWidth: 1100, margin: '0 auto', ...reveal('concepts') }}
        >
          ...
          <div style={{ maxWidth: 900, margin: '0 auto' }}>
            ...
            <div className="comparison-table">
              <div className="comp-row comp-row-header">
                <div className="comp-classical">Classical Computer</div>
                <div className="comp-quantum">Quantum Computer</div>
              </div>
              {[
                ...
                <div key={i} className={`comp-row${i % 2 !== 0 ? ' comp-row-odd' : ''}`}>
                  <div className="comp-classical">{classic}</div>
                  <div className="comp-quantum">{quantum}</div>
                </div>
              ))}
              <div className="comp-row comp-row-footer">
                <div className="comp-classical" />
                <div className="comp-quantum" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section
          ...
          style={{ padding: 'clamp(60px, 8vw, 100px) clamp(16px, 4vw, 24px)', maxWidth: 680, margin: '0 auto', ...reveal('timeline') }}
        >
        ...
        <section
          ...
          data-section="cta"
          style={{
            padding: 'clamp(60px, 8vw, 100px) clamp(16px, 4vw, 24px) clamp(80px, 10vw, 120px)',
            textAlign: 'center',
            borderTop: '1px solid rgba(255,255,255,0.06)',
            ...reveal('cta'),
          }}
        >
          ...
          <div className="hero-cta-group" style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap', width: '100%', maxWidth: 480, margin: '0 auto' }}>
