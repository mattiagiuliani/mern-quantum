  ...
  webServer: [
    {
      ...
      // Always point the frontend at the local E2E backend (port 3001).
      // For the dev server this overrides any VITE_API_URL_DEV set in .env.local.
      // For vite preview (CI) the value is baked in at build time so this is a no-op,
      // but the CI build has no .env file and falls back to http://localhost:3001/api/v1.
